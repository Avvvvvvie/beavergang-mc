...
execute at @s as @p[advancements={gang:interact_with_itemframe=true},distance=..6] if score @s deck matches 10000010.. if score @s deck matches ..10000199 run function gang:turn/removecard
