...
- To shuffle a deck, place it, sneak and right click the item as often as you want.
- To hide/show a card, right click it without sneaking. To rotate it, sneak + right click.
- If you hold a deck in your hand and sneak, it will be converted into a pile and vice-versa (only if you have an empty pile item).
