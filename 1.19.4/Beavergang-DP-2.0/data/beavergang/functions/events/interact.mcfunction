...
execute if data entity @s {SelectedItem:{tag:{beavergang:1b}}} unless predicate beavergang:is_sneaking run function beavergang:events/interaction_paths/no_sneak
