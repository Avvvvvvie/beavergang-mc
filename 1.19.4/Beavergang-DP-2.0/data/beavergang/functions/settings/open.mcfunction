...
summon interaction ^0.5 ^-0.4 ^1.5 {height: 1f, width: 0.5f, Tags:[beavergang_settings,newInteraction,place],Passengers:[{id:"minecraft:text_display",text:'{"text":"dynamic","italic":"true"}',Tags:[beavergang_settings,newInteraction,neg,place],Passengers:[{id:"minecraft:text_display",text:'{"text":"Place:"}',Tags:[beavergang_settings,newInteraction,translate,neg]}]}]}
summon interaction ^-0.5 ^-0.4 ^1.5 {height: 1f, width: 0.5f, Tags:[beavergang_settings,newInteraction,take],Passengers:[{id:"minecraft:text_display",text:'{"text":"dynamic","italic":"true"}',Tags:[beavergang_settings,newInteraction,pos,take],Passengers:[{id:"minecraft:text_display",text:'{"text":"Take:"}',Tags:[beavergang_settings,newInteraction,translate,pos]}]}]}
